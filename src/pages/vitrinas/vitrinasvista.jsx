...
export function VitrinasVista() {
        ...
        fetch(baseUrl)
            ...
            .then((data) => {
                if (data && Array.isArray(data)) {
                    ...
                    const categoriaData = data.filter(item => item.categoria?.toLowerCase() === 'vitrinas');
    ...
    return (
        <>
            ...
            <div className="filtrod grid grid-cols-3 gap-4 w-4/5 mx-auto items-center">
                ...
                <div className="mt-6 col-span-2 sm:col-span-2 flex items-center gap-2">
                    ...
                    <input
                        ...
                        placeholder="Buscar Accessorios ..."
                        aria-label="Buscar accesorio" // Added aria-label for accesibility

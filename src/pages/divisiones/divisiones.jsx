...
export function DivisionesBaño() {
    ...
    fetch(baseUrl)
      ...
      .then((data) => {
        if (data && Array.isArray(data)) {
          ...
          const categoriaData = data.filter(item => item.categoria?.toLowerCase() === 'catalogodivisiones');
  ...
  return (
    <>
      ...
      <div className="filtros grid grid-cols-3 gap-4 w-4/5 mx-auto items-center">
        ...
        {/*Filtro por categoria mas abajo y con icono a la izquierda */}

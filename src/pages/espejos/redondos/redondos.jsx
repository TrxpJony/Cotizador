        ...
        fetch(baseUrl)
            ...
            .then((data) => {
                if (data && Array.isArray(data)) {
                    // Filtrar los datos para que solo se muestren los de categoria "redondos"
                    const categoriaData = data.filter(item => item.categoria?.toLowerCase() === 'redondos');

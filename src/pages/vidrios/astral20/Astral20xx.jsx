...
const generatePDF = () => {
      ...
      doc.text(`${jambaastPrice.toFixed(2)}`, 170, 65);
      ...
      doc.text(`${horizontalInferiorMovilastPrice.toFixed(2)}`, 170, 95);
      doc.text(`Traslape:`, 20, 100);
      doc.text(`${doubleHeight} mm (2)`, 120, 100);
      doc.text(`${traslapeastPrice.toFixed(2)}`, 170, 100);
      doc.text(`Enganche:`, 20, 105);
      doc.text(`${doubleHeight} mm (2)`, 120, 105);
      doc.text(`${engancheastPrice.toFixed(2)}`, 170, 105);
  ...
  return (
    ...
    <Table aria-label="TABLA NAVE">
      ...
      <TableBody>
        ...
        <TableRow key="5">
          <TableCell><strong>Traslapeast:</strong> </TableCell>
          <TableCell>{doubleHeight} mm (2) </TableCell>
          <TableCell>${traslapeastPrice.toFixed(2)}</TableCell>
        </TableRow>
        <TableRow key="6">
          <TableCell><strong>Engancheast:</strong> </TableCell>
          <TableCell>{doubleHeight} mm (2) </TableCell>

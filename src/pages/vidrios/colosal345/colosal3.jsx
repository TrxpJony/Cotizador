...
import EnviarDimensiones from '../../../components/cotizador/colosal345/enviarDimenciones';
import useCalculoPrecios from '../../../components/cotizador/colosal345/useCalculoPrecios';
...
import DetalleTablas from '../../../components/cotizador/colosal345/detalleTablas';
import ColosalImg from '../../../img/colox.png';
        ...
        <>
            <div className='door-container'>
                <div className='door-frame'>
                    <img src={ColosalImg} alt='COLOSAL 345 XO-OX' className='door-image' />
                    <EnviarDimensiones onDimensionsChange={handleDimensionsChange} />
                    <h2 className='text-right text-4xl font-bold'>${totalPrice.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h2>
                    <br />
                    <AddTableDoor doors={doors} />
                    <PrintTableDoor doors={doors} title={"Puerta Corrediza Sistema Colosal 345"} image={ColosalImg} totalPrice={totalPrice} />

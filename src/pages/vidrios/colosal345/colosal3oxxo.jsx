...
const Colosal3oxxo = () => {
  ...
  const generatePDF = () => {
    ...
    doc.text(`${componentTotals.perimetralNave.totalSize} mm (16)`, 120, 75);
    ...
    doc.text(`adaptador:`, 20, 85);
    doc.text(`${componentTotals.adaptador.totalSize} mm (4)`, 120, 85);
    doc.text(`${componentTotals.adaptador.totalPrice.toFixed(2)}`, 170, 85);

    // Tabla Accesorios
    doc.setFontSize(12); // Título más pequeño
    doc.setTextColor(cyanBlue);
    doc.text('Accesorios', 20, 95); // Título de la sección Empaquecol

    // Tabla de Accesorios
    doc.setFontSize(10);
    doc.setTextColor('black');

    doc.text('Pieza', 20, 100);
    doc.text('Precio', 170, 100);

    doc.text(`Kit de Cierre:`, 20, 105);
    doc.text(`${accessoryTotals.kitCierre.cantidad}`, 120, 105);
    doc.text(`${accessoryTotals.kitCierre.totalPrice.toFixed(2)}`, 170, 105);

    doc.text(`Kit de Cierre con Llave:`, 20, 110);
    doc.text(`${accessoryTotals.kitCierreConLlave.cantidad}`, 120, 110);
    doc.text(`${accessoryTotals.kitCierreConLlave.totalPrice.toFixed(2)}`, 170, 110);

    doc.text(`Cubeta de Angeo Negra:`, 20, 115);
    doc.text(`${accessoryTotals.cubetaAngeo.cantidad}`, 120, 115);
    doc.text(`${accessoryTotals.cubetaAngeo.totalPrice.toFixed(2)}`, 170, 115);

    doc.text(`Rodamiento Simple en Agujas 70 Kilos:`, 20, 120);
    doc.text(`${accessoryTotals.rodamientoSimple.cantidad}`, 120, 120);
    doc.text(`${accessoryTotals.rodamientoSimple.totalPrice.toFixed(2)}`, 170, 120);

    doc.text(`Rodamiento Doble en Agujas 140 Kilos:`, 20, 125);
    doc.text(`${accessoryTotals.rodamientoDoble.cantidad}`, 120, 125);
    doc.text(`${accessoryTotals.rodamientoDoble.totalPrice.toFixed(2)}`, 170, 125);

    doc.text(`Caja Deflectora:`, 20, 130);
    doc.text(`${accessoryTotals.cajaDeflectora.cantidad}`, 120, 130);
    doc.text(`${accessoryTotals.cajaDeflectora.totalPrice.toFixed(2)}`, 170, 130);

    doc.text(`Kit 8 Escuadras de Alineación:`, 20, 135);
    doc.text(`${accessoryTotals.Kit8Escuadras.cantidad}`, 120, 135);
    doc.text(`${accessoryTotals.Kit8Escuadras.totalPrice.toFixed(2)}`, 170, 135);

    doc.text(`Kit 4 Anclas Esquinero:`, 20, 140);
    doc.text(`${accessoryTotals.kit4Anclas.cantidad}`, 120, 140);
    doc.text(`${accessoryTotals.kit4Anclas.totalPrice.toFixed(2)}`, 170, 140);

    doc.text(`Kit 4 Alza Guia/Tope Hoja Fija/Movil:`, 20, 145);
    doc.text(`${accessoryTotals.kit4Alza.cantidad}`, 120, 145);
    doc.text(`${accessoryTotals.kit4Alza.totalPrice.toFixed(2)}`, 170, 145);

    doc.text(`Kit 4 Tapa y Tapeta Enganche:`, 20, 150);
    doc.text(`${accessoryTotals.kit4Tapa.cantidad}`, 120, 150);
    doc.text(`${accessoryTotals.kit4Tapa.totalPrice.toFixed(2)}`, 170, 150);

    doc.text(`Kit 2 Cortavientos:`, 20, 155);
    doc.text(`${accessoryTotals.kit2Cortavientos.cantidad}`, 120, 155);
    doc.text(`${accessoryTotals.kit2Cortavientos.totalPrice.toFixed(2)}`, 170, 155);

    doc.text(`Kit 4 Seguros de Hoja Fija:`, 20, 160);
    doc.text(`${accessoryTotals.kit4Seguros.cantidad}`, 120, 160);
    doc.text(`${accessoryTotals.kit4Seguros.totalPrice.toFixed(2)}`, 170, 160);
    
    // Tabla Empaque
    doc.setFontSize(12); // Título más pequeño
    doc.setTextColor(cyanBlue);
    doc.text('Empaque', 20, 170); // Título de la sección Empaque
    ...
    doc.setFontSize(12); // Título más pequeño
    doc.setTextColor(cyanBlue);
    doc.text('Utilitarios', 20, 200); // Título de la sección Empaque

        ...
        <>
            <div className='w-full bg-white shadow-md p-4 flex flex-col mx-auto'>
                <div className='px-4 sm:px-12 md:px-24 lg:px-48 text-center sm:text-left'>
                    <p className='py-2 text-pretty text-2xl sm:tex-3xl md:text-4xl font-semibold tracking-tight text-gray-700'>
                        Sistema zinu X
                    </p>
                </div>
            </div>
                ...
                <div className='px-10'>
                    ...
                    <div className='relative w-full h-56 sm:h-72 md:h-96 bg-black/20 mb-5 rounded-xl'>
                        <div className='top-0 left-0 w-full h-full'>
                            <img src={zinuImg} alt="SISTEMA ZINU X" className='w-full h-56 sm:h-full object-cover rounded-xl' />
                        </div>
                    </div>
                    <div className='mb-2'>

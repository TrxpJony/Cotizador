...
const Colosal = () => {
  ...
  const horizontalInferiorFijacolPrice = dbPrices.horizontalInferiorFijacol ? (dbPrices.horizontalInferiorFijacol * (halfWidth / 1000)) : 0;
  const horizontalInferiorMovilcolPrice = dbPrices.horizontalInferiorMovilcol ? (dbPrices.horizontalInferiorMovilcol * (halfWidth / 1000)) : 0;

...
const handleGlassChange = (e) => {
  ...
  const totalPrice =
    ...
    const generatePDF = () => {
      ...
      doc.text('Detalle de la cotización Colosal PC 2.6 XX', 70, 34); // Texto blanco en la cabecera
      ...
      doc.text(`${guiaSimplecolPrice.toFixed(2)}`, 170, 65);
      ...
      doc.text(`${doubleHalfWidth} mm (2)`, 120, 95);

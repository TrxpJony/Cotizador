...
const handleGlassChange = (e) => {
  ...
  const totalPrice =
    ...
    const generatePDF = () => {
      ...
      doc.text('Detalle de la cotización Colosal PC 2.6 OXXO', 70, 34); // Texto blanco en la cabecera
      ...
      doc.text(`${doubleHeight} mm (2)`, 120, 65);
      doc.text(`${jambacolPrice.toFixed(2)}`, 170, 65);
      ...
      doc.text(`${doubleHalfWidth} mm (4)`, 120, 85);
      doc.text(`${horizontalSuperiorcolPrice.toFixed(2)}`, 170, 85);
      doc.text(`Horizontal Inferior Fija:`, 20, 90);
      doc.text(`${halfWidth} mm`, 120, 90);
      doc.text(`${horizontalInferiorFijacolPrice.toFixed(2)}`, 170, 90);
      ...
      doc.text(`${cuadrupleHeight} mm (4)`, 120, 100);
      ...
      doc.text(`Adaptador:`, 20, 110);
      doc.text(`${totalHeight} mm`, 120, 110);
      doc.text(`${adaptadorcolPrice.toFixed(2)}`, 170, 110);


      // Tabla Accesorios
      doc.setFontSize(12); // Título más pequeño
      doc.setTextColor(cyanBlue);
      doc.text('Accesorios', 20, 120); // Título de la sección Empaquecol
      ...
      doc.text(`${kitCierrecolPrice.toFixed(2)}`, 170, 130);

      doc.text(`Kit de Cierre con Llave:`, 20, 135);
      doc.text(`${kitCierreConLlavecolPrice.toFixed(2)}`, 170, 135);
      
      doc.text(`Cubeta de Angeo Negra:`, 20, 140);
      doc.text(`${cubetaAngeoPrice.toFixed(2)}`, 170, 140);

      doc.text(`Rodamiento Simple en Agujas:`, 20, 145);
      doc.text(`${rodamientoSimple70colPrice.toFixed(2)}`, 170, 145);

      doc.text(`Rodamiento Doble en Agujas:`, 20, 150);
      doc.text(`${rodamientoDoble140colPrice.toFixed(2)}`, 170, 150);

      doc.text(`Caja Deflectora:`, 20, 155);
      doc.text(`${cajaDeflectoraPrice.toFixed(2)}`, 170, 155);

      // Tabla Empaquecol
      doc.setFontSize(12); // Título más pequeño
      doc.setTextColor(cyanBlue);
      doc.text('Empaque', 20, 165); // Título de la sección Empaquecol
      ...
      doc.text(`Empaquecol (Alto):`, 20, 175);
      doc.text(`${empaquecolHeight} mm`, 120, 175);
      doc.text(`${empaquecolPrice.toFixed(2)}`, 170, 175);

      doc.text(`Empaquecol (Ancho):`, 20, 180);
      doc.text(`${empaquecolWidth} mm`, 120, 180);
      doc.text(`${empaquecolPrice.toFixed(2)}`, 170, 180);
      ...
      doc.setFontSize(12); // Título más pequeño
      doc.setTextColor(cyanBlue);
      doc.text('Utilitarios', 20, 195); // Título de la sección Empaquecol
      ...
      doc.text(`16`, 120, 205);
      doc.text(`${tornillosPrice.toFixed(2)}`, 170, 205);

      doc.text(`Silicona:`, 20, 210);
      doc.text(`${siliconaPrice.toFixed(2)}`, 170, 210);
      ...
      doc.text(formattedTotal, 150, 235); // Total

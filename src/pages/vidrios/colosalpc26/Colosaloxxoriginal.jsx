...
const Colosaloxxo = () => {
  ...
  const traslapecolPrice = dbPrices.traslapecol ? (dbPrices.traslapecol * (cuadrupleHeight / 1000)) : 0;
  const enganchecolPrice = dbPrices.enganchecol ? (dbPrices.enganchecol * (cuadrupleHeight / 1000)) : 0;
  const adaptadorcolPrice = dbPrices.adaptadorcol ? (dbPrices.adaptadorcol * (totalWidth / 1000)) : 0;

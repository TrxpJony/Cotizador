...
import colosalImage from '../../../img/awa6h.png'; // Importar la imagen
...
useEffect(() => {
  ...
  const perimetralAwa = (totalHeight && totalWidth) ? ((totalWidth / 6) * 12 + (totalHeight * 12)) : 0;
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(10);
    doc.text('Detalle de la cotización Sistema Awa 6 Hojas   ', 70, 34);
  ...
  return (
   <div className="door-container">
      ...
      <div className="parts-list">
        <strong><h1>SISTEMA AGUA 6 HOJAS</h1></strong>
        ...
        <Table aria-label="TABLA NAVE">
          ...
          <TableBody>
            ...
            <TableRow key="2">
              ...
              <TableCell>{perimetralAwa} mm (24)</TableCell>

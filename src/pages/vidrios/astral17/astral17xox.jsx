...
import EnviarDimensiones from '../../../components/cotizador/astral17xox/enviarDimenciones';
import useCalculoPrecios from '../../../components/cotizador/astral17xox/useCalculoPrecios';
...
import DetalleTablas from '../../../components/cotizador/astral17xox/detalleTablas';
                ...
                <div className='px-10'>
                    ...
                    <div className='relative w-full h-56 sm:h-72 md:h-96 bg-black/20 mb-5 rounded-xl shadow-lg'>
                        <div className='top-0 left-0 w-full h-full'>
                            <img src={Astral20Image} alt="ASTRAL 2.0 XO - OX" className='w-full h-56 sm:h-full object-cover rounded-xl' />
                        </div>
                    </div>
                    <div className='mb-2'>

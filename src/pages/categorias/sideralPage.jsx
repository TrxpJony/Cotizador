  ...
  useEffect(() => {
    fetch(baseUrl)
      ...
      .then((data) => {
        ...
        const filteredData = data.filter(item => item.categoria === 'sideral');
    ...
    <>
      ...
      <div className="filter-frame-page">
        <div className="flex justify-between items-center">
          <strong>
            <h1 className="text-[1.8em] text-[#00bcd4] mt-2">SIDERAL 2.4 TIPOLOGÍAS</h1>
          </strong>
        </div>
      </div>

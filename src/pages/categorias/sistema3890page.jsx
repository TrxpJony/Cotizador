    ...
    fetch(baseUrl)
      ...
      .then((data) => {
        if (data && Array.isArray(data)) {
          ...
          const categoriaData = data.filter(item => item.categoria?.toLowerCase() === 'sistema3890');
    ...
    <>
      <div className="w-full bg-white shadow-md p-4 flex flex-col mx-auto">
        <div className="px-4 sm:px-12 md:px-24 lg:px-48 text-center sm:text-left">
          <h1 className="py-2 text-pretty text-2xl sm:text-3xl font-semibold tracking-tight text-gray-700">
            Sistema 3890 tipologías
          </h1>
        </div>
      </div>

  ...
  useEffect(() => {
    fetch(baseUrl)
      ...
      .then((data) => {
        ...
        const filteredData = data.filter(item => item.categoria === 'astral17');
    ...
    <>
      ...
      <div className="filter-frame-page">
        <div className="flex justify-between items-center">
          <strong>
            <h1 className="text-[1.8em] text-[#00bcd4] mt-2">ASTRAL 1.7 TIPOLOGÍAS</h1>
          </strong>
        </div>
      </div>

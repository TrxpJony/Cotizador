  ...
  useEffect(() => {
    fetch(baseUrl)
      ...
      .then((data) => {
        ...
        // Filtrar los vidrios con categoría 'astral20'
        const filteredData = data.filter(item => item.categoria === 'astral20');
    ...
    <>
      ...
      <div className="filter-frame-page">
        <div className="flex justify-between items-center">
          <strong>
            <h1 className="text-[1.8em] text-[#00bcd4] mt-2">ASTRAL 2.0 TIPOLOGÍAS</h1>
          </strong>
        </div>
      </div>

...
export function Colosal345page() {
  ...
  useEffect(() => {
    fetch(baseUrl)
      ...
      .then((data) => {
        ...
        const filteredData = data.filter(item => item.categoria === 'colosal345');
    ...
    <>
      ...
      <div className="filter-frame-page">
        <div className="flex justify-between items-center">
          <strong>
            <h1 className="text-[1.8em] text-[#00bcd4] mt-2">COLOSAL 345 TIPOLOGÍAS</h1>
          </strong>
        </div>
      </div>

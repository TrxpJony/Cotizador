...
const categorias = [
    ...
    { label: "Sensor touch", key: "touch" },
    { label: "Sensor dual", key: "dual" },
    { label: "Sensor de proximidad", key: "proximidad" },
    { label: "sensor con reloj", key: "reloj" },
    { label: "Sensor con desempañante", key: "desempañante" },
    { label: "Sensor no touch", key: "notouch" },
    { label: "Sensor bluetooth", key: "touch" },
];

...
export function Luzled1101vista() {
    ...
    const filterByCategory = (categoryKey) => {
        ...
        // Reset paginarion to the first page when filtering
        setCurrentPage(1);
    };
    ...
    return (
        <>
            ...
            <div className="filtros grid grid-cols-3 gap-4 w-4/5 mx-auto items-center">
                {/*Barra de búsqueda mas baja y con icono a la izquierda */}
                <div className="mt-6 col-span-2 sm:col-span-2 flex items-center gap-2">
                    ...
                    <input
                        ...
                        placeholder="Buscar Accesorio" // Added aria-label for accesibility
                        aria-label="Buscar Accesirio"
            ...
            <div className="card-frame">
                <p>
                    Mostrando {paginatedList.length} de {filteredList.length} accesorios dispinibles.
                </p>
                        ...
                        {(onClose) => (
                            <>
                                ...
                                <ModalBody>
                                    ...
                                    <p>Color: {selectedItem.color}</p> </ModalBody>
                                <ModalFooter>

...
import { useEffect, useState } from "react";
  ...
  const categorias = [
    ...
    { label: "Diseños de fruteros", key: "sandblastingfruteros" },
    { label: "Diseños de animales", key: "sandblastinganimales" },
    { label: "Diseños de flores", key: "sandblastingflores" },
    { label: "Diseños de esquinas", key: "sandblastingesquineros" },
    { label: "Diseños de cenefas", key: "sandblastingcenefas" },
  ];
        ...
        .then((data) => {
          if (data && Array.isArray(data)) {
            ...
            const categoriasPermitidas = [
              'sandblastingfruteros', 'sandblastingflores', 'sandblastingesquineros', 'sandblastingcenefas', 'sandblastinganimales' ];

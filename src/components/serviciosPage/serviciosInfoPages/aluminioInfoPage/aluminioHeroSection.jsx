        ...
        <div ref={containerRef}>
            <section className="relative py-16 lg:py-64 w-full min-h-screen flex items-center justify-center bg-gray-900 text-white overflow-hidden">
                <img
                    ...
                    alt="Fondo de casa moderna con perfilería de aluminio"
                    ...
                    <div className="container mx-auto px-6 lg:px-0 flex flex-col-reverse lg:flex-row items-center justify-between relative z-10">
                        ...
                        <div className="w-full lg:w-2/3 text-center lg:text-left space-y-6 ">
                            ...
                            <h1 className="aluminio-hero-text text-4xl md:text-5xl font-extrabold text-white mb-2 leading-tight drop-shadow-sm">
                                Perfilería de Aluminio para Puertas y Ventanas Modernas | <br className="hidden md:inline" /> Soluciones Personalizadas
                            </h1>
                            <p className="aluminio-hero-text text-lg text-white mb-4">
                                ...
                                , diseñamos e instalamos perfiles de aluminio a medida para puertas, ventanas y sistemas de aluminio modernos, Trabajamos con aluminio de alta calidad para ofrecer soluciones duraderas, estéticas y funcionales, tanto para hogares como para espacios comerciales.
                            </p>
                            {/* Botones de acción */}
                            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-6">
                                ...
                                <a
                                    href="/contact"
                                    className="aluminio-hero-button inline-flex items-center gap-2 border-transparent border bg-cyan-500 text-white hover:bg-transparent hover:border-white hover:text-white px-6 py-2 rounded-2xl font-semibold hover:shadow-xl transition-shadow"
                                >
                        ...
                        <div className=" flex justify-center mb-10 lg:mb-0 -slow">
                            <img
                                src={puerta}
                                alt="Puerta moderna de aluminio con vidrio templado ideal para espacios residenciales"

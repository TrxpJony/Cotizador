        ...
        <>
            <section className="relative mt-6 md:mt-8">
                <div className="mx-auto max-w-7xl w-full px-5 sm:px-8 md:px-14 lg:px-5">
                    <div className="bg-white  rounded-3xl mt-10 sm:mt-12 border shadow-lg border-gray-200 
                                 shadow-slate-200/50 text-gray-700 objec ">
                        <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-12 lg:max-w-7xl lg:px-8">
                            <h2 className="font-bold text-2xl sm:text-3xl md:text-4xl text-gray-900">Nuestros vidrios</h2>
                            ...
                            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 ">
                                {Imagenes.map((imagen) => (
                                    <div
                                        key={imagen.id} className="group relative"

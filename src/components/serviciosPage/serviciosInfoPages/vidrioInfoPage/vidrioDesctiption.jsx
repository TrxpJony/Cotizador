                ...
                >
                    ...
                    <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
                        ...
                        <div className="pt-8 mb-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {/* Laminado */}
                            <div
                                className="px-5 sm:px-6 lg:px-8 py-5 rounded-3xl border shadow-lg
                            ...
                            >
                                <div className="rounded-xl bg-body p-3 w-max relative">
                                    <GiCrackedGlass size={28} className="text-cyan-500" />
                                </div>
                                <h2 className="w-max relative font-semibold md:text-xl">
                                    Laminado
                                </h2>
                                <p className="text-gray-600">Formado por dos hojas de vidrio unidas con una lámina intermedia que evita el desprendimiento al romperse.</p>
                            </div>
                            {/* Templado */}
                            <div
                                className="px-5 py-5 sm:px-6 lg:px-8 rounded-3xl border shadow-lg
                                           border-gray-200 shadow-slate-200/50 bg-white 
                                           text-gray-700 relative overflow-hidden"
                            >
                                <div className="rounded-xl bg-body p-3 w-max relative">
                                    <GiShatter size={28} className="text-cyan-500" />
                                </div>
                                <h2 className="w-max relative font-semibold md:text-xl">
                                    Templado
                                </h2>
                                <p className="text-gray-600">5 veces más resistente que el vidrio común. En caso de rotura, se fragmenta en pequeños trozos no filosos.</p>
                            </div>

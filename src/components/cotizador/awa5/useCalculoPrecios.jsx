...
const useCalculoPrecios = ({ width, height }, selectedAccessories = []) => {
    ...
    useEffect(() => {
        ...
        const halfCuadDouble = ((totalWidth / 6) * 12) + totalHeight * 12;
        ...
        const pisavidrioPerimetralAwaPrice = getPrice("empaqueAwa", empaqueAwaHeight + empaqueAwaWidth);
        ...
        const tornillosPrice = (memoizedPrices.tornillos ? Number(memoizedPrices.tornillos) : 0) * 98;
        ...
        const total = 
            ...
            sillarEmpotrarAwaPrice + sillaSobreponerAwaPrice + perimetralAwaPrice +
            pisavidrioPerimetralAwaPrice + empaqueAwaPrice + felpaPrice + tornillosPrice + siliconaPrice + AccessoriosPrice;
        setTotalPrice(total);
        setCalculatedValues({
            totalWidth,
            verticalInferiorAwa,

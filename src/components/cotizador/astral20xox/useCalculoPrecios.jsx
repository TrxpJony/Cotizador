...
const useCalculoPrecios = ({ width, height }, selectedAccessories = []) => {
    ...
    useEffect(() => {
        ...
        const horizontalInferiorFijaast = totalWidth / 4 + 124;
        const horizontalInferiorMovilast = (totalWidth / 4 + 2) * 2;
        ...
        const horizontalInferiorFijaastPrice = getPrice("horizontalInferiorFijaast", horizontalInferiorFijaast);
        const horizontalInferiorMovilastPrice = getPrice("horizontalInferiorMovilast", horizontalInferiorMovilast);
        ...
        setCalculatedValues({
            ...
            jambaastPrice,
            horizontalInferiorFijaast,
            horizontalInferiorMovilast,

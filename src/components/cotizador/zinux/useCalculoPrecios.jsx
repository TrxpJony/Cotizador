...
const useCalculoPrecios = ({ width, height }, selectedAccessories = []) => {
    ...
    useEffect(() => {
        ...
        const total =
            marcoPerimetralZinuPrice + perimetralNaveZinuPrice + pisaVidrioZinuPrice + verticalHorizontalesCaZinuPrice +
            empaqueZinuPrice + felpaPrice + tornillosPrice + siliconaPrice + accessoriesPrice;
        ...
        setCalculatedValues({
            ...
            cierreHZinuPrice: memoizedPrices.cierreHZinu ? Number(memoizedPrices.cierreHZinu) : 0,

...
const DetalleTablas8025 = ({ calculatedValues, dimensions, onAddDoor, onAccessoryChange, selectedAccessories, useCalculoPrecios, selectedGlass }) => {
    const {
        totalWidth,
        doubleHeight,
        doubleHalfWidth,
                ...
                <Table aria-label="Tabla Nave">
                    ...
                    <TableBody>
                        ...
                        <TableRow key="6">
                            ...
                            <TableCell>${adaptador?.toFixed(2)}</TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
                <br />
                    ...
                    <TableBody>
                        ...
                        <TableRow key="4">
                            <TableCell>
                                ...
                                />
                                <strong>Rodamiento Simple en Agujas (4)</strong>
                            </TableCell>
                        ...
                        <TableRow key="5">
                            <TableCell>
                                ...
                                />
                                <strong>Rodamiento Doble (4)</strong>
                            </TableCell>
